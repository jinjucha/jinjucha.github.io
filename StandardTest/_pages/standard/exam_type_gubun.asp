...
<div id="wrapper">
	...
	<div id="container">
		...
		<div id="contArea">
			...
			<!-- standardArea -->
			<form id="mainForm" name="mainForm"  method="post" action="./json/inspc_proc.asp">
						...
						<div class="exam01">
							...
							<div class="pr">
								<p>
									...
									<a href="javascript:goWrite();" class="btn_ok"><img src="https://pic.neungyule.com/nekids/img/standard/btn_ok.png" alt="확인" /></a>
								</p>
							</div>
						</div>
					</div>
