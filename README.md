...
> 안녕하세요! ***"항상 도전하고 싶은, 주도적인 자바 개발자"*** 차진주입니다! <br>
> 사용자에게 편리하고 혁신적인 웹 서비스 제공에 욕심을 가지고 있는 웹 개발자입니다.<br>
> 다수 프로젝트에 투입되어 사업 환경에 맞춰 업무를 진행하며 웹 개발 역량을 길러왔습니다.
<br />

# 📝Projects
그동안 진행했던 프로젝트들 입니다!  
최근 2년간 신규 사업 프로젝트 메인 개발자으로서 주업무는 ***전반적인 프로젝트 핵심 기능과 API 개발*** 이었으며
구조 설계부터 개발, 운영 업무를 도맡아 진행하였습니다.
